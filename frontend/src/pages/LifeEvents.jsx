...
export default function LifeEvents() {
  ...
  const toggleIncluded = async event => { await axios.patch(`/api/life-events/${event.id}/toggle`, { included_in_projection: !event.included_in_projection }); load() }
  return <div>
