  ...
  return (
    <div>
      ...
      <Section title="Household 401k Balance Split &amp; HSA">
        ...
        <Row label="Withdrawal Order in Retirement" hint="Taxable-first defers tax the longest (usually the better lifetime outcome) and applies everywhere. Proportional draws all three buckets blended by balance every year, starting the moment you retire — applies to Retirement Projection, Monte Carlo, and Stress Tests; SWR, Roth Conversion, and Tax Efficiency keep their own taxable-first draw order regardless. Hold Back Reserved Accounts spends pension/SS/401k/Roth/IRA only, leaving any account you've flagged as 'held back' (on the Accounts page) untouched as an emergency reserve — Monte Carlo and Stress Tests only; Retirement Projection, SWR, Roth Conversion, and Tax Efficiency still spend from reserved accounts, so expect a more optimistic number on those pages when this is selected">
