...
export default function App() {
  ...
  const pages = {
    dashboard:Dashboard, accounts:Accounts, retirement:RetirementProjection, stresstest:StressTestWhatIf,
    ...
    rettools:RetirementTools, allocation:Allocation, annualplan:AnnualPlan, cashflow:CashFlow, goals:GoalsFunding,
  }
